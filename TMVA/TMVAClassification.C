...
//FILEOUT
   ...
   TString outfileName( "TMVA_1GeV_overlap.root" );
...
//   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile,
 //                                              "!V:!Silent:Color:DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=Classification" );
   TMVA::Factory* factory = new TMVA::Factory("TMVAMulticlass_1GeV_overlap",outputFile,
		                           "!V:!Silent:Color:!DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=multiclass" );
   	TFile* file = TFile::Open("/scratchfs/higgs/yudan/SingleParticle/Reco//all_1GeV/PID_1GeV_E30L_E10mm_H48L_H10mm_1GeV.root");
...
//   TCut mycuts = "NTrk==1 && MCPP[2]/MCPEn<0.7"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   ...
   factory->AddTree( treePi, TString("Pi"), 1. ,"abs(cosTheta)>0.55&&abs(cosTheta)<0.75");
   factory->AddTree( treeMu, TString("Mu"), 1.,"abs(cosTheta)>0.55&&abs(cosTheta)<0.75");
   factory->AddTree( treeE, TString("E"), 1.,"abs(cosTheta)>0.55&&abs(cosTheta)<0.75");
