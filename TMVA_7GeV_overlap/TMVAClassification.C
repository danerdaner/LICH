...
void TMVAClassification( TString myMethodList = "" )
{
  ...
  TString outfileName( "TMVA_7GeV_overlap.root" );
  TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
  TMVA::Factory* factory = new TMVA::Factory("TMVAMulticlass_7GeV_overlap",outputFile,
		                           "!V:!Silent:Color:!DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=multiclass" );
  TFile* file_0 = TFile::Open("/afs/ihep.ac.cn/users/y/yudan/yudan/proPID/tmp_7GeV/output.root_7.root");
