...
void TMVAClassification( TString myMethodList = "" )
{
  ...
  TString outfileName( "TMVA_70GeV_endcap.root" );
  TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
  TMVA::Factory* factory = new TMVA::Factory("TMVAMulticlass_70GeV_endcap",outputFile,
  ...
  factory->AddTree( treePi, TString("Pi"), 1.,"abs(cosTheta)>0.75");
  factory->AddTree( treeMu, TString("Mu"), 1.,"abs(cosTheta)>0.75");
  factory->AddTree( treeE, TString("E"), 1.,"abs(cosTheta)>0.75");
