...
void TMVAClassification( TString myMethodList = "" )
{
  ...
  TString outfileName( "TMVA_2GeV_overlap.root" );
  TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
  TMVA::Factory* factory = new TMVA::Factory("TMVAMulticlass_2GeV_overlap",outputFile,
		                           "!V:!Silent:Color:!DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=multiclass" );
  TFile* file_0 = TFile::Open("/afs/ihep.ac.cn/users/y/yudan/yudan/proPID/tmp_2GeV/output.root_2.root");
